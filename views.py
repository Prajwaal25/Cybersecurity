...
def readDetails(contract_type):
    ...
    deployed_contract_address = '0xE2E6EAAd0dA861d04Ae53629e2e7C7B81e86D5bf' #hash address to access AuthPrivacyChain contract
...
def saveDataBlockChain(currentData, contract_type):
    ...
    deployed_contract_address = '0xE2E6EAAd0dA861d04Ae53629e2e7C7B81e86D5bf' #contract address
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
...
def AccessShareData(request):
    if request.method == 'GET':
        ...
        if arr[0]!='':
            ...
            output+='<th><font size="" color="black">View Data</th></tr>'
            files = []
